...
| `$B9EA`   | `log_FAC1`             | DONE     | From the Microsoft BASIC, original name: LOG       |
...
| `$BB12`   | `div_FAC2_FAC1`        | DONE     | From the Microsoft BASIC, original name: FDIVT     |
...
| `$BC1B`   | `round_FAC1`           | DONE     | From the Microsoft BASIC, original name: ROUND     |
...
| `$BCF3`   | `FIN`                  | PARTIAL  | From the Microsoft BASIC Only for 38k memory model |
...
| `$BFED`   | `exp_FAC1`             | PARTIAL  | From the Microsoft BASIC Only for the 38k model    |
...
| `$E26B`   | `sin_FAC1`             | DONE     | From the Microsoft BASIC, original name: SIN       |
| `$E2B4`   | `tan_FAC1`             | DONE     | From the Microsoft BASIC, original name: TAN       |
